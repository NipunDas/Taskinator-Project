...
function MyApp() {
  ...
  function fetchTasks() {
    const promise = fetch("http://localhost:8000/task-lists/65553647a73a1b75066a47ab");
    console.log(promise);
    return promise;
  }

  function deleteTask(id) {
    const promise = fetch(`http://localhost:8000/task-lists/65553647a73a1b75066a47ab/tasks/${id}`, {
      method: "DELETE"
    });
 ...
 function removeTask(id) {
  ...
  return (
    <div>
        ...
        <Grid name="High Priority" id={1} taskData={filteredTasks} removeTask={removeTask}></Grid>
        <Grid name="Medium Priority" id={2} taskData={filteredTasks} removeTask={removeTask}></Grid>
        <Grid name="Low Priority" id={3} taskData={filteredTasks} removeTask={removeTask}></Grid>
    </div>
  );
}
