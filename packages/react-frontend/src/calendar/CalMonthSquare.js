	...
	return(
		<div className='CalendarSquare'>
			...
			{hasev[0] && (
					...
					position: 'absolute', 
					transform: `translate(${x_pos + width * 1 / 20}px, ${y_pos + height * (0 * 4 + 3) / 16}px)`,
					border: 'solid',
					width: width * 9 / 10,
					height: height * 1 / 5
					}}>
			...
			{hasev[1] && (
					...
					position: 'absolute', 
					transform: `translate(${x_pos + width * 1 / 20}px, ${y_pos + height * (1 * 4 + 3) / 16}px)`,
					border: 'solid',
					width: width * 9 / 10,
					height: height * 1 / 5
					}}>
			...
			{hasev[2] && (
					...
					position: 'absolute', 
					transform: `translate(${x_pos + width * 1 / 20}px, ${y_pos + height * (2 * 4 + 3) / 16}px)`,
					border: 'solid',
					width: width * 9 / 10,
					height: height * 1 / 5
					}}>
